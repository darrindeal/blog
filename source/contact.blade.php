...
<form action="/contact" class="mb-12">
    <div class="flex flex-wrap mb-6 -mx-3">
        <div class="w-full md:w-1/2 mb-6 md:mb-0 px-3">
            ...
            <input
                ...
                name="name"
                class="block bg-gray-800 w-full border shadow rounded-lg outline-none mb-2 px-4 py-3"
                required
            >
        </div>
    ...
    <div class="w-full mb-12">
        ...
        <textarea
            ...
            rows="4"
            name="message"
            class="block bg-gray-800 w-full border shadow rounded-lg outline-none appearance-none mb-2 px-4 py-3"
    ...
    <div class="flex justify-end w-full">
        <input
            type="submit"
            value="Submit"
            class="block bg-gray-600 hover:bg-gray-500 text-white text-sm font-semibold leading-snug tracking-wide uppercase shadow rounded-lg cursor-pointer px-6 py-3"
        >
    </div>
</form>
@stop
